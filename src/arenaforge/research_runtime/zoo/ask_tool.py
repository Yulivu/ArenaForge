...
The discovery and bring-up agents (:mod:`arenaforge-runtime.zoo.agent_stages`) sometimes hit a
...
This is deliberately *not* the Coordinator's :class:`~arenaforge-runtime.coordinator.tools.AskUserTool`:
...
class ConsoleAskUserTool(Tool):
    ...
    description = (
        ...
        "treat as the baseline — the baseline is the starting point ArenaForge Research Runtime will optimize, "
