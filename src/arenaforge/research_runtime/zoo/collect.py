"""The `arenaforge-runtime benchmark add` collection pipeline.
...
class CollectResult:
    ...
    def pending(self) -> list[str]:
        ...
        return [
            "Stage 0 survey: confirm the canonical source, the general baseline, and what ArenaForge Research Runtime edits",
            ...
            "Re-run `arenaforge-runtime benchmark verify` until green, then human-accept into arenaforge-runtime-zoo/",
        ]
