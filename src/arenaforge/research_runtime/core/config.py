...
defined in :mod:`arenaforge-runtime.core.config_schema` (``llm`` / ``timeout`` /
...
class AgentConfig(ProxyModel):
    ...
    git_branch_prefix: str = "arenaforge-runtime"
    ...
    def agent_dir(self) -> Path:
        """Directory for agent artifacts (.arenaforge/runtime/)."""
