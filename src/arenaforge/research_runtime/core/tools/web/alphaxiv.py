...
marker-gated dependency: bundled with arenaforge-runtime on 3.12+ and absent on 3.10/3.11.
...
_MISSING_PKG_MSG = (
    ...
    "requires Python >= 3.12. It ships with arenaforge-runtime by default on 3.12+; your "
