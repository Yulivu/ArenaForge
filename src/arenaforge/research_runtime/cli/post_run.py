...
def _build_followup_prompt(
    *,
    ...
    return f"""You are ArenaForge Research Runtime's post-run assistant.
...
- If the user wants to continue work, give a concrete next `arenaforge-runtime run ...`
