    ...
    def _check_llm(self) -> CheckResult:
        ...
        if self.provider not in self._PROVIDER_ENV:
            return CheckResult(
                ...
                hint="run `arenaforge-runtime setup` and choose anthropic, openai, or litellm",
            )
        ...
        if env_vars is None:
            ...
            return CheckResult(
                ...
                hint="set ANTHROPIC_API_KEY / OPENAI_API_KEY, or run `arenaforge-runtime setup`",
            )
        ...
        return CheckResult(
            ...
            hint=f"export {primary}=... or run `arenaforge-runtime setup`",
        )
    ...
    def _check_openai_oauth() -> CheckResult:
        ...
        try:
            ...
            return CheckResult(
                ...
                hint="reinstall arenaforge-runtime",
            )
        ...
        if tokens is None:
            return CheckResult(
                ...
                hint="run `arenaforge-runtime login openai`",
            )
    ...
    def _check_anthropic_oauth() -> CheckResult:
        ...
        if tokens is None:
            return CheckResult(
                ...
                hint="run `arenaforge-runtime login claude`",
            )
