...
ArenaForge Research Runtime needs an LLM, but it does not need a *paid* one to get started. Several
...
# user can override at the prompt; they're for *trying ArenaForge Research Runtime on your own task*,
