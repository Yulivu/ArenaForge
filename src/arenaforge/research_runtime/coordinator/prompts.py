...
automated research through an arenaforge-runtime-guided Idea Tree.
...
# ---------------------------------------------------------------------------
# Section 3: ArenaForge Research Runtime Cycle Protocol
# ---------------------------------------------------------------------------
...
def _ideate_body_section(config: CoordinatorConfig) -> str:
    """Return the body of ArenaForge Research Runtime Cycle Step 2 (IDEATE).
...
def _arbor_cycle_protocol_section(config: CoordinatorConfig) -> str:
    ...
    return f"""\
# ArenaForge Research Runtime Cycle Research Protocol
