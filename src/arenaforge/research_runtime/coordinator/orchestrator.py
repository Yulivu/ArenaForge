...
Instead of creating a fresh Agent per arenaforge-runtime cycle, runs one continuous
...
class CoordinatorOrchestrator:
    """Orchestrates arenaforge-runtime-guided research via a single persistent Agent.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        parts.append(
            f"## Guidelines\n\n"
            f"- Hard cap: {self.config.max_cycles} arenaforge-runtime cycles{depth_note} "
