...
Usage::
    ...
    from arenaforge.research_runtime.events.mock import emit_mock_run
...
MOCK_SCRIPT: list[tuple[str, dict[str, Any]]] = [
    ...
    (E.CHECKPOINT_SAVED, {"path": ".arenaforge/runtime/checkpoint/checkpoint.json", "cycle": 1, "reason": "cycle_end"}),
