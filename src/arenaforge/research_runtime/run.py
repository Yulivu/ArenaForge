...
""",
    ...
    cmd = [sys.executable, "-m", "arenaforge.research_runtime.coordinator.main", "--cwd", cwd, "-v"]
    ...
    for md in meta_dirs:
        if md.exists():
            ...
            break
    artifacts.append((cwd_p / ".arenaforge/runtime" / "experiments.jsonl", "experiments.jsonl"))
        ...
        try:
            ...
            if files_to_commit:
                try:
                    ...
                    msg = f"arenaforge: cache baseline results (score={score})"
                except (json.JSONDecodeError, OSError):
                    msg = "arenaforge: cache baseline results"
                try:
            ...
            if post_dirty:
                ...
                _cleanup_dirs = [".arenaforge/runtime", "submissions", "models", "logs", "analysis", "runs", "cache"]
