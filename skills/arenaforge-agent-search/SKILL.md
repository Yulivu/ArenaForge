---
name: arenaforge-agent-search
description: "Related-work and novelty annotation phase for ArenaForge. Use after a node has been experimentally validated, especially before merge decisions, to emulate SearchIdeaContext/SearchIdeaContextParallel/SearchStatus, validated-node gating, background SearchAgent behavior, and structured prior-art summaries."
---

# ArenaForge Search Agent
...
Native ArenaForge usually runs SearchAgent in the background:
