---
name: arenaforge-agent-plugins-hitl-budget
description: "Domain adaptation, human-in-the-loop, and budget policy phase for ArenaForge. Use when a run mentions plugins, plugin profiles, mle_kaggle, eval_contract, protected_paths, required_outputs, lifecycle hooks, convergence, budget_policy, RunTraining stages, AskUser, or interaction modes auto/direction/review/collaborative."
---

# ArenaForge Plugins, HITL, And Budget
...
Default ArenaForge behavior favors long real experiments. Do not invent staged
...
If a plugin disables strict skills, do not force `arenaforge-agent-ideate`'s
